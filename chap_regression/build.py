...
code/gyminf/python/regression/. Damit die Seite auch direkt über file://
funktioniert (fetch() ist dort gesperrt), werden die Dateien in ein
JavaScript-Objekt geschrieben, anstatt zur Laufzeit geladen. (Die
Python-Werkbänke selbst brauchen für die Code-*Ausführung* trotzdem eine
...
# Das Gauss-Portrait aus dem Kapitel; die Webseite kann es nicht selber
# rendern (kein LaTeX-Bibsystem hier). Laut sources/people-pics.bib
# (Eintrag pic:gauss) ist dieses Bild public domain.
FIGURES = {
